...
public class AjaxExample {
	private String URL = " https://demos.telerik.com/aspnet-ajax/ajaxloadingpanel/functionality/explicit-show-hide/defaultcs.aspx";
...
WebElement selectedDatesTextElement = driver.findElement(By.xpath(".//*[@id='ctl00_ContentPlaceholder1_Label1']"));
...
String expectedTextAfterAjaxCall = "Wednesday, November 01, 2017";
